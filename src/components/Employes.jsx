...
const Employes = () => {
  return (
    <section className="py-14">
      <div className="container max-w-[900px] mx-auto px-14 relative">
        <Swiper
          navigation={true}
          modules={[Navigation]}
        ...
        >
          <SwiperSlide className="mySlide flex items-center justify-center flex-col">
            <p className="text-center text-base md:text-lg text-slate-700 mb-10">
            ...
            <span className="text-sm text-slate-800 text-center">
